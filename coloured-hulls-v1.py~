...
for doc in polished_hull.cursor:
    ...
    if prov not in counts: counts[prov]=0
    else: counts[prov]+=1
...
#ax.set_xticklabels(fontname="Arial", fontsize=fs)
#ax.set_yticklabels(fontname="Arial", fontsize=fs)

#ax.set_ylabel(fontname="Arial", fontsize=fs)
#ax.set_ylabel(fontname="Arial", fontsize=fs)
