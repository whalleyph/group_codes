...
class doscar:
    ...
    def plot_dos (self, shift=True, show=False, axis_limits=None):
        import numpy as np
        import pylab as plt
        dos = self.get_dos()
        if shift:
...
if __name__ == '__main__':
  ...
  parser.add_argument('-sh', '--shift', action='store_true', default=True,
      help='shift energy by efermi or not?')
  parser.add_argument('-s', '--show', action='store_true', default=False,
      help='show the plot or not?')
  parser.add_argument('-f', '--file', default='DOSCAR',
      help='DOSCAR file')
  parser.add_argument(
      '-l', 
      '--axis_limits',
  ...
  doscar().read(args.file).plot_dos(shift=args.shift, show=args.show,
